...
const CategoryPage = () => {
  ...
  const stores = allStores.filter(
    (s) => s.category.toLowerCase() === categorySlug?.toLowerCase()
  );
      ...
      <div className="relative h-40 md:h-52 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          <div className="container mx-auto">
            <Link to="/" className="inline-flex items-center gap-1 text-primary-foreground/70 hover:text-primary-foreground text-sm font-body mb-2 transition-colors">
      ...
      <div className="container mx-auto px-4 py-10">
        {stores.length === 0 ? (
          <div className="text-center py-16">
            <p className="text-muted-foreground font-body text-lg">Nenhuma loja encontrada nesta categoria.</p>
          </div>
        ) : (
